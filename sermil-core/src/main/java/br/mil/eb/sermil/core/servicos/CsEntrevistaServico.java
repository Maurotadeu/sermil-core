...
public class CsEntrevistaServico {
   ...
   @Transactional
   public CsEntrevista salvarEntrevistaCidadao(final CsEntrevista entrevista, final Cidadao cidadao, final String ra, final Usuario usr) throws EntrevistaCsPersistenseFailException {
      try {
