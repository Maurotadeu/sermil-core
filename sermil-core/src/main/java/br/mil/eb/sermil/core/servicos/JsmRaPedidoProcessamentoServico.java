...
public class JsmRaPedidoProcessamentoServico {
  ...
  */
  ...
  @PreAuthorize("hasAnyRole('adm','dsm','csm','del','jsm')")
  public Path gerarArquivoEmergencial(final RaItens item) throws SermilException {
  ...
  @PreAuthorize("hasAnyRole('adm','dsm','csm','del','jsm')")
  public Path gerarArquivoSasm(final RaItens item) throws SermilException, IOException, RaMestreException {
    // Criando arquivo
