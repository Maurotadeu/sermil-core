  ...
  public static class PK implements Comparable<CidExar.PK>, Serializable {
    ...
    public String toString() {
      return new StringBuilder(this.getCidadaoRa() == null ? "RA" : this.getCidadaoRa().toString())
          .append(" - ").append(this.getApresentacaoQtd() == null ? "NR APRES EXAR" : this.getApresentacaoQtd())
          .toString();
    }
    ...
    public int hashCode() {
      final int prime = 31;
      int result = 1;
      result = prime * result + ((this.apresentacaoQtd == null) ? 0 : this.apresentacaoQtd.hashCode());
