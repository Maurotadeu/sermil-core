 ...
 * @author Abreu Lopes
 * @since 3.0
 * @version $Id: EstatArrecadacao.java 2397 2014-04-16 14:06:08Z wlopes $
 */
@Entity
@Table(name = "ESTAT_ARRECADACAO")
@NamedQueries({
  @NamedQuery(name = "EstatArrecadacao.listarPorAno", query = "SELECT e FROM EstatArrecadacao e WHERE e.jsm = :jsm AND e.ano = :ano ORDER BY e.mes")
})
