 ...
 * @author Abreu Lopes
 * @since 3.0
 * @version $Id: CidExar.java 2426 2014-05-14 15:01:41Z wlopes $
 */
@Entity
@Table(name = "CID_EXAR")
public final class CidExar implements Comparable<CidExar>, Serializable {

  private static final long serialVersionUID = 5279598515565655112L;
  ...
  public String toString() {
    return new StringBuilder(this.getPk().getApresentacaoQtd() == null ? "NR" : this.getPk().getApresentacaoQtd().toString())
      .append(" - ")
  ...
  public static class PK implements Comparable<CidExar.PK>, Serializable {
    ...
    /** serialVersionUID. */
    private static final long serialVersionUID = -1138215157722323080L;
