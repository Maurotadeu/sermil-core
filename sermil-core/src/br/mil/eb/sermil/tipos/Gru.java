 ...
 * Receita:
 * 11111-2 = Taxa de Serviço Militar
 * 11112-0 = Multas Previstas na LSM
 * @author Abreu Lopes
 * @since 5.0
 * @version $Id$
 */
public class Gru implements Serializable {
    ...
    public static final String RECEITA_TAXA = "11111-2";

    public static final String RECEITA_MULTA = "11112-0";
