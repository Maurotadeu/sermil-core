...
public class DaoFactoryJpaImpl extends DaoFactory {
    ...
    * 
    * @param daoClass
    *           Classe do DAO a ser instanciado
   ...
   // Implementar métodos definidos na fábrica abstrata DaoFactory para
   // instanciar o DAO
   ...
   // Criar implementações concretas dos DAO a serem instanciados (usando
   ...
   public static class CidArrecadacaoDaoJpa extends GenericDaoJpaImpl<CidArrecadacao, CidArrecadacao.PK>
         implements CidArrecadacaoDao {
   }

   public static class CidAuditoriaDaoJpa extends GenericDaoJpaImpl<CidAuditoria, CidAuditoria.PK>
         implements CidAuditoriaDao {
   }

   public static class CidAdiamentoDaoJpa extends GenericDaoJpaImpl<CidAdiamento, CidAdiamento.PK>
         implements CidAdiamentoDao {
   }

   public static class CidAverbacaoDaoJpa extends GenericDaoJpaImpl<CidAverbacao, CidAverbacao.PK>
         implements CidAverbacaoDao {
   }

   public static class CidCertificadoDaoJpa extends GenericDaoJpaImpl<CidCertificado, CidCertificado.PK>
         implements CidCertificadoDao {
   }
   ...
   public static class CselFuncionamentoDaoJpa extends GenericDaoJpaImpl<CselFuncionamento, Integer>
         implements CselFuncionamentoDao {
   }
   ...
   public static class DstbParametroDaoJpa extends GenericDaoJpaImpl<DstbParametro, DstbParametro.PK>
         implements DstbParametroDao {
   }
   ...
   public static class EstatAlistamentoEscDaoJpa extends GenericDaoJpaImpl<EstatAlistamentoEsc, Integer>
         implements EstatAlistamentoEscDao {
   }

   public static class EstatArrecadacaoDaoJpa extends GenericDaoJpaImpl<EstatArrecadacao, Integer>
         implements EstatArrecadacaoDao {
   }
   ...
   public static class PortalMensagemDaoJpa extends GenericDaoJpaImpl<PortalMensagem, Integer>
         implements PortalMensagemDao {
   }

   public static class PostoGraduacaoDaoJpa extends GenericDaoJpaImpl<PostoGraduacao, String>
         implements PostoGraduacaoDao {
   }

   public static class PreAlistamentoDaoJpa extends GenericDaoJpaImpl<PreAlistamento, Long>
         implements PreAlistamentoDao {
   }
   ...
   public static class SelTributacaoDaoJpa extends GenericDaoJpaImpl<SelTributacao, SelTributacao.PK>
         implements SelTributacaoDao {
   }
