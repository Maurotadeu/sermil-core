  ...
  */
  ...
  public Path gerarArquivo(final Byte rm, final Short cs, final Integer ano, final Short tipo) throws SermilException {
    ...
    try {
      ...
      final StringBuilder nome = new StringBuilder(CAB).append(String.format("%02d",rm)).append(new SimpleDateFormat("yy").format(new Date())).append(String.format("%03d", cs)).append("000");
